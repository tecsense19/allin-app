...
export const styles = StyleSheet.create({
    ...
    contactListContainer: { backgroundColor: COLOR.white, marginTop: 10, },
    ...
    ContactFlatList: { paddingHorizontal: 20, height: '100%' },
    OncontactScreenSend: { position: 'absolute', bottom: 50, backgroundColor: COLOR.green, alignSelf: 'center', padding: 10, paddingHorizontal: 50, borderRadius: 10 }, sendTxt: { fontSize: 20, fontWeight: 'bold', color: COLOR.black },
