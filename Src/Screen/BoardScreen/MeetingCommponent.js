...
//                 <View style={{ backgroundColor: COLOR.black, height: 40, justifyContent: 'center', borderTopRightRadius: 10, borderTopLeftRadius: 10 }}>
//                     <Text style={styles.meetingTxt}>Meeting</Text>
//                 </View>
//                 <View style={styles.meetingDetailsView}>
//                     <View style={{ backgroundColor: COLOR.green, alignSelf: 'flex-start', padding: 5, borderRadius: 15 }}>
//                         <Text style={styles.Heading}>Title: </Text>
//                     </View>
//                     <Text style={styles.HeadingContent}>{item.title}</Text>
//                     <View style={{ height: 2, backgroundColor: COLOR.lightgray, marginTop: 10 }}></View>
//                     <View style={{ backgroundColor: COLOR.green, alignSelf: 'flex-start', padding: 5, borderRadius: 15, marginTop: 10 }}>
//                         <Text style={styles.Heading}>Description:</Text>
//                     </View>

//                     <Text style={styles.HeadingContent}>{item.description?.length > 60 ? item.description.slice(0, 60) + '....' : item.description}</Text>
//                     <View style={{ height: 2, backgroundColor: COLOR.lightgray, marginTop: 5 }}></View>
...
//                 </View>
//                 <View style={{ width: item.assigned_users.length <= 2 ? 60 : 75, alignSelf: 'center', flexDirection: 'row', alignItems: 'center', right: item.assigned_users.length <= 2 ? -20 : 0, bottom: 35 }}>
//                     {member?.map((i, ind) => {
//                         return (
//                             <View>
...
//     Heading: { alignSelf: 'flex-start', fontWeight: 'bold', color: COLOR.black, fontSize: 13 },
//     HeadingContent: { color: COLOR.black, fontSize: 12, fontWeight: '500', marginTop: 10 },
...
//     meetingTxt: { fontSize: 18, fontWeight: 'bold', color: COLOR.white, textAlign: 'center' },
//     meetinglistContainer: { backgroundColor: COLOR.white, marginTop: 10, borderRadius: 10, margin: 10, shadowOffset: { height: 5, width: 1 }, shadowOpacity: 0.2, shadowRadius: 3 },
