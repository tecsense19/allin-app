      ...
      <Modal animationType="slide" transparent={true} visible={this.state.modalVisible}>
        ...
        <View style={[styles.modalContainer, modalContainer]}>
          <View style={styles.filterInputStyleContainer}>
            ...
            <TextInput autoCapitalize="words" autoFocus onChangeText={this.filterCountries} placeholder={filterText || 'Search here...'} style={[styles.filterInputStyle, filterInputStyle]} placeholderTextColor={placeholderTextColor} />
            <TouchableOpacity onPress={() => Keyboard.dismiss()}>
              <Image source={{ uri: 'https://cdn4.iconfinder.com/data/icons/standard-free-icons/139/Find01-512.png' }} style={{ height: 25, width: 25, paddingHorizontal: 5 }} />
...
const styles = StyleSheet.create({
  ...
  openDialogView: {
    flexDirection: 'row',
    alignItems: 'center',
    // borderWidth:1//flag view outside
  },
  filterInputStyle: {
    flex: 1,
    paddingTop: 10,
    paddingBottom: 10,
    backgroundColor: '#f1f1f1', borderRadius: 10, paddingLeft: 15,
    color: 'black',
    fontSize: 15, fontWeight: '700', marginRight: 10
    // borderWidth: 1
  },
  searchIcon: {
    padding: 10,
  ...
  filterInputStyleContainer: {
    ...
    alignItems: 'center',
    backgroundColor: 'white', height: 55, borderTopRightRadius: 20, borderTopLeftRadius: 20, paddingHorizontal: 10,
  },
  phoneInputStyle: {
