			...
			>
				<SafeAreaView style={styles.safeAreaView}>
					<TouchableWithoutFeedback onPress={() => toggleModal(false)}>
						<View style={{ flex: 1 }}>
							<View style={{ flex: 1, position: 'absolute', top: hight > 845 ? '55%' : '56.3%', backgroundColor: 'white', left: 20, right: 20, bottom: 0 }}>
								<View
									style={[
...
const styles = StyleSheet.create({
	...
	searchBarStyle: {
		flex: 1,
		height: "100%",
		fontSize: 16, paddingLeft: 10, fontWeight: '600', color: 'black'
	},
